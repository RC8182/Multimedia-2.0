...
export const DesktopNav = () => {
    ...
    const getNavItems= async ()=>{
      const response= await (enlace)
      .then((response)=> response.json());
      setItems(response);
      console.log(response);
    };
    useEffect(() => { getNavItems(); }); 
    //
  ...
  const NAV_ITEMS = [
    {
      ...
      children: [
        {
          label: 'Leo',
          subLabel: 'Dibus de leo el Camión!',
          href: 'http://localhost:3000/leo',
        },
        {
          label: 'Blad & Nikita',
          subLabel: 'Dibus de Blad & Nikita! ',
          href: 'http://localhost:3000/vlad',
        },
      ],
    },
    {
